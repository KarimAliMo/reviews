...
let surprise = document.querySelector(`.random-btn`);
let counter = 0;
...
surprise.addEventListener(`click`, function () {
    ...
    photo.src = reviews[ran].img;
    name.textContent = reviews[ran].name;
    job.textContent = reviews[ran].job;
    info.textContent = reviews[ran].text;
});
